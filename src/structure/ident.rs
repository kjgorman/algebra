...
impl IdentityAdditive for usize { #[inline] fn zero() -> usize { 0   } }
...
impl IdentityAdditive for isize { #[inline] fn zero() -> isize { 0   } }
...
impl IdentityMultiplicative for usize { #[inline] fn unit() -> usize { 1   } }
...
impl IdentityMultiplicative for isize { #[inline] fn unit() -> isize { 1   } }
